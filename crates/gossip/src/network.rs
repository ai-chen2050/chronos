...
impl Network {
    pub fn new(
        ...
        // content-address message by using the hash of it as an ID, use blake2 as the hash func,more faster
...
mod test {
    ...
    async fn test_gossip_two_nodes_by_dm() {
        ...
        let alice_handle = tokio::task::spawn(async move {
            ...
            let mut alice =
                Network::new(local_key, None, listen_addr, Discover::Config, 50).unwrap();
