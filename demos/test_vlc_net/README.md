...
do
    ...
    ./test_vlc_net  --server server"$I".json generate --host /ip4/127.0.0.1/tcp/ --port "$PORT" --topic vlc --trigger-us 1000 --bootnodes "/ip4/127.0.0.1/tcp/9601" --tokio-console-port "$TOKIO_CONSOLE_PORT"
done
```
